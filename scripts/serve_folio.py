...
PUBLIC.update(f'folio/assets/popular-{name}-{mode}.png' for name in ['solitude','blackturq','blackgold','mechanoonna','batou','lasthorizon'] for mode in ['dark','light'])
PUBLIC.update(f'folio/assets/badge-{name}-{mode}.png' for name in ['solitude','blackturq','blackgold','mechanoonna','batou','lasthorizon'] for mode in ['dark','light'])
